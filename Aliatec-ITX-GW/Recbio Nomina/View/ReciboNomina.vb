...
Public Class ReciboNomina
    ...
    Private Sub ReciboNomina8_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        picLogo1.Image = System.Drawing.Image.FromFile(Me.Parameters("logo").Value)

        'Me.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" & _
        'sConnection, "sp_Reporte_ReciboNomina9 @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
        ...
        '"@IdLugarPago = " + Me.Parameters("IdLugarPago").Value + "," & _
        ...
        'Dim SubReportePercepciones As New ReciboNominaARSubPercepcionConDato
        ...
        'SubReportePercepciones.Parameters("IdEmpleado").Value = "'" + txtIdEmpleado.Text + "'"
        ...
        'Dim SubReportePercepcionesCopia As New ReciboNominaARSubPercepcionConDato
        ...
        'SubReportePercepcionesCopia.Parameters("IdEmpleado").Value = "'" + txtIdEmpleado.Text + "'"
        ...
        'Me.SubReport4.Report = SubReportePercepcionesCopia

        ''******* SUBREPORTE DEDUCCIONES **************/
        'Dim SubReporteDeducciones As New ReciboNominaARSubDeduccionConDato
        ...
        'SubReporteDeducciones.Parameters("IdEmpleado").Value = "'" + txtIdEmpleado.Text + "'"
        ...
        'Dim SubReporteDeduccionesCopia As New ReciboNominaARSubDeduccionConDato
        ...
        'SubReporteDeduccionesCopia.Parameters("IdEmpleado").Value = "'" + txtIdEmpleado.Text + "'"
        ...
        ''******* SUBREPORTE SALDOS **************/
        'Dim SubReporteSaldos As New ReciboNomina9Saldos
        ...
        'SubReporteSaldos.Parameters("IdEmpleado").Value = "'" + txtIdEmpleado.Text + "'"
        ...
        'Me.SubReport3.Report = SubReporteSaldos

        ''******* SUBREPORTE SALDOS COPIA **************/
        'Dim SubReporteSaldosCopia As New ReciboNomina9Saldos
        ...
        'SubReporteSaldosCopia.Parameters("IdEmpleado").Value = "'" + txtIdEmpleado.Text + "'"
        ...
        'Me.SubReport6.Report = SubReporteSaldosCopia
    End Sub
