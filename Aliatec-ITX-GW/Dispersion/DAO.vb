...
Public Class DAO
    ...
    Private Const distribucionCliente As String = "spq_Reporte_DistribucionGW '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@folioDesde','@folioHasta','@UID','@LID','@idAccion'"
    Private Const distribucionProducto As String = "spq_Reporte_DistribucionGW_Producto '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@folioDesde','@folioHasta','@UID','@LID','@idAccion'"
    Private Const distribucionCentroCostos As String = "spq_Reporte_DistribucionGW_Centro_Costos '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@folioDesde','@folioHasta','@UID','@LID','@idAccion'"
    Private Const distribucionCentroTrabajo As String = "spq_Reporte_DistribucionGW_Centro_Trabajo '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@folioDesde','@folioHasta','@UID','@LID','@idAccion'"
    Private Const distribucionTotalCliente As String = "spq_Reporte_DistribucionGW_TOTALES_Cliente '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@folioDesde','@folioHasta','@UID','@LID','@idAccion'"
    ...
    Private Const PolizaGWProv As String = "sp_Poliza_ContableGW_Prov '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@Anio','@Periodo','@UID','@LID','@idAccion'"
    ...
    Public Function Layout(ByVal ReportesProceso As EntitiesITX.ReportesProceso, ByVal opL As String) As DataSet
        ...
        Try
            Select Case opL
                ...
                Case "distribucionCliente"
                    comandstr = distribucionCliente
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds

                Case "distribucionProducto"
                    comandstr = distribucionProducto
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds

                Case "distribucionCentroCostos"
                    comandstr = distribucionCentroCostos
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds

                Case "distribucionCentroTrabajo"
                    comandstr = distribucionCentroTrabajo
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds

                Case "distribucionTotalCliente"
                    comandstr = distribucionTotalCliente
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds

                Case "distribucionTotalProducto"
                    comandstr = distribucionTotalProducto
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds

                Case "distribucionTotalCentroCostos"
                    comandstr = distribucionTotalCentroCostos
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds
