...
Public Class CartaFiniquito
    ...
    Public Sub New(ByVal reporte As Entities.ReportesProceso)
        ...
        Me.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_Reporte_CartaFiniquitoGW @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<" & _
